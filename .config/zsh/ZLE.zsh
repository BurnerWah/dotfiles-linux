...
autoload -Uz widget/cd         && zle -N widget/cd
autoload -Uz edit-command-line && zle -N edit-command-line
autoload -Uz widget/ctrl-z     && zle -N widget/ctrl-z
autoload -Uz grep2awk          && zle -N grep2awk
autoload -Uz widget/history    && zle -N widget/history
autoload -Uz widget/sudo       && zle -N widget/sudo
autoload -Uz widget/z          && zle -N widget/z
...
bindkey -M viins '^R'   widget/history  # input a command from shell's history
