...
complete -c userdel -s R -l root -d 'Apply changes in the CHROOT_DIR directory and use the configuration files fro…'
complete -c userdel -s P -l prefix -d 'Apply changes in the PREFIX_DIR directory and use the configuration files fro…'
